            ...
            Expanded(
              child: Column(
                children: [
                  ...
                  _buildPackageContainer(text: "Medinet Hepatic (Liver) Health Check-up Package"),
                  SizedBox(height: 35.h),
                  _buildFeatureRow(
                    icon: Icons.circle,
                  ...
                  _buildFeatureRow(icon: Icons.circle, text: "SGOT"),
                  _buildFeatureRow(icon: Icons.circle, text: "ALP (Alkaline Phosphate)"),
                  _buildFeatureRow(icon: Icons.circle, text: "HbsAg"),
                  _buildFeatureRow(icon: Icons.circle, text: "Anli HCV"),
                  _buildFeatureRow(icon: Icons.circle, text: "Fasting Lipid Profile"),
                  _buildFeatureRow(icon: Icons.circle, text: "Total Protein AG ratio \n(Albumin, Globulin Ratio)"),
                  _buildFeatureRow(icon: Icons.circle, text: "Prothrombin Time"),
                ...
                Navigator.push(
                  ...
                  MaterialPageRoute(
                    builder: (context) => AppointmentTime(
                      packageName: "Medinet Hepatic (Liver) Health Check-up Package",
                      packageFee: "2000",
                    ),
                  ),
                );
